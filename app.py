    ...
    <body>
        ...
        <section class="hero" id="about">
            <div class="container">
                ...
                <p>
                    Bridging development, operations, and automation. I build containerized applications,
                    Kubernetes deployments, and CI/CD pipelines with Docker, Helm, Jenkins, AWS, and EKS.
                </p>
                <div>
                ...
                <div class="projects-grid">
                    ...
                    <div class="project-card">
                        <div class="project-content">
                            ...
                            <p>
                                Designed and deployed a full DevOps pipeline for a Dockerized frontend and backend application.
                                The project uses Jenkins for CI/CD, Docker Hub for image publishing, Helm for release management,
                                Kubernetes on AWS EKS for orchestration, and NGINX Ingress for application routing.
                            </p>
                    ...
                    <div class="project-card">
                        <div class="project-content">
                            ...
                            <p>
                                Containerized Flask application deployed on AWS EC2. Automated CI/CD pipelines using
                                GitHub Actions with integrated health checks and Docker orchestration.
                            </p>
                            <div class="skill-tags" style="margin-bottom: 15px;">
                                <span class="tag">Flask</span>
                                <span class="tag">Docker</span>
                    ...
                    <div class="project-card">
                        <div class="project-content">
                            <h3>Sharingan</h3>
                            <p>
                                Bash automation tool that streamlines the reconnaissance process.
                                Reduces manual information gathering time significantly during security assessments.
                            </p>
                            <div class="skill-tags" style="margin-bottom: 15px;">
